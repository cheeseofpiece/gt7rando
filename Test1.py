    ...
    if len(cars_list) > 0:
        ...
        if generate_opponents_enabled.get():
            ...
            if group_limit_enabled.get():
                filtered_cars_list = [car for car in cars_list if car[18] == picked_car[18]]
            else:
                filtered_cars_list = cars_list
...
wheels = read_csv('wheel.csv')
paint = read_csv('paint.csv')
...
tyre_limit_checkbox.pack(anchor="nw", padx=10)
...
pp_difference_limit_checkbox.grid(row=3, column=0, sticky="w")

pp_difference_label = ttk.Label(custom_tab, text="PP difference (Above and below)")
pp_difference_label.grid(row=4, column=0, sticky="w")

pp_difference_entry = ttk.Entry(custom_tab)
pp_difference_entry.insert(0, "50")
pp_difference_entry.grid(row=5, column=0, sticky="w")
...
engine_type_limit_checkbox.grid(row=6, column=0, sticky="w")
...
type_limit_checkbox.grid(row=7, column=0, sticky="w")
...
year_difference_limit_checkbox.grid(row=8, column=0, sticky="w")

year_difference_label = ttk.Label(custom_tab, text="Year difference (Above and below)")
year_difference_label.grid(row=9, column=0, sticky="w")

year_difference_entry = ttk.Entry(custom_tab)
year_difference_entry.insert(0, "10")
year_difference_entry.grid(row=10, column=0, sticky="w")
...
aspiration_limit_checkbox.grid(row=11, column=0, sticky="w")
...
drivetrain_limit_checkbox.grid(row=12, column=0, sticky="w")
...
country_limit_checkbox.grid(row=13, column=0, sticky="w")
...
tag_limit_checkbox.grid(row=14, column=0, sticky="w")

opponents_label_custom = tk.Label(custom_tab, text="Opponent Cars:")
opponents_label_custom.grid(row=18, column=0, sticky="w")

car_label_custom = tk.Label(custom_tab, text="Random Car: ")
car_label_custom.grid(row=0, column=1, sticky="e")
car_label_custom.config(font=("Arial", 16))

track_label_custom = tk.Label(custom_tab, text="Random Track: ")
track_label_custom.grid(row=1, column=1, sticky="e")
track_label_custom.config(font=("Arial", 16))

race_info_label = tk.Label(custom_tab, text="Random Laps - Random Time - Random Weather")
race_info_label.grid(row=2, column=1, sticky="e")
race_info_label.config(font=("Arial", 16))

miles_label = ttk.Label(custom_tab, text="Max race mileage")
miles_label.grid(row=9, column=1, sticky="e")

miles_entry = ttk.Entry(custom_tab)
miles_entry.insert(0, "50")
miles_entry.grid(row=10, column=1, sticky="e")
